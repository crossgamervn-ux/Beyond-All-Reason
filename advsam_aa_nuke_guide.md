...
2. **Sát thương và Bán kính nổ:** Dù đã bị giảm nhẹ để cân bằng, bán kính nổ (`areaofeffect`) vẫn ở mức `1500` (lớn hơn nuke tiêu chuẩn là 1280) và sát thương là `11000`, quá đủ để hủy diệt các phi đội lớn.
...
4. **Tăng giá thành xây dựng:**
   - **Metal:** 8000 (gốc: 1600~1650)
   - **Energy:** 120000 (gốc: 32000~33000)
